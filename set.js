...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "50933616800", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "50933616800", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "🌸 Yusuke PDG 🌸", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "🌸 Yusuke PDG 🌸", // Added // Input Yours custom...
...
BOT_NAME: process.env.BOT_NAME || "DÉMONIAQUE", //  don't change 
